...
REM
REM Generated by Vivado on Fri Aug 01 01:24:36 +0530 2025
...
call xsim  program_counter_tb_behav -key {Behavioral:sim_1:Functional:program_counter_tb} -tclbatch program_counter_tb.tcl -log simulate.log
